...
- [p42. 接雨水](./src/p42.rs) (前缀最大值+后缀最大值)
- [p238. 除自身以外数组的乘积](./src/p238.rs)
- [p303. 区域和检索——数组不可变](./src/p303.rs)
- [p523. 连续的子数组和](./src/p523.rs) (经典题目)
- [p525. 连续数组](./src/p525.rs) (经典题目)
- [p560. 和为K的子数组](./src/p560.rs) (经典题目)
- [p724. 寻找数组的中心下标](./src/p724.rs)
- [p1480. 一维数组的动态和](./src/p1480.rs)
- [p1685. 有序数组中差绝对值之和](./src/p1685.rs) (前缀和+后缀和)
...
- [p496. 下一个更大元素 I](./src/p496.rs) (单调栈+哈希表)
- [p503. 下一个更大元素 II](./src/p503.rs)
- [p739. 每日温度](./src/p739.rs)
...
- [p2342. 数位和相等数对的最大和](./src/p2342.rs) (哈希+最大堆)
...
- [p12. 整数转罗马数字](./src/p12.rs) (贪心+哈希表)
- [p122. 买卖股票的最佳时机 II](./src/p122.rs)
- [p135. 分发糖果](./src/p135.rs)
- [p406. 根据身高重建队列](./src/p406.rs) (排序+贪心，经典题目)
- [p435. 无重叠区间](./src/p435.rs) (经典题目)
- [p452. 用最少数量的箭引爆气球](./src/p452.rs) (经典题目)
- [p455. 分发饼干](./src/p455.rs)
- [p605. 种花问题](./src/p605.rs)
- [p665. 非递减数列](./src/p665.rs) (经典题目)
- [p763. 划分字母区间](./src/p763.rs) (贪心+哈希表)

## 回溯

- [p17. 电话号码的字母组合](./src/p17.rs) (经典题目)
...
- [p189. 轮转数组](./src/p189.rs) (数学，数组)
- [p202. 快乐数](./src/p202.rs)
- [p223. 矩形面积](./src/p223.rs) (几何)
- [p263. 丑数](./src/p263.rs) (数学，对循环的理解)
- [p326. 3的幂](./src/p326.rs) (数学、理解循环)
...
- [p2520. 统计能整除数字的位数](./src/p2520.rs) (取余)
...
- [p2352. 相等行列对](./src/p2352.rs) (矩阵+哈希表)
