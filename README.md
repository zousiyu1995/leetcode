...
- [p2586. count the number of vowel strings in range 统计范围内的元音字符串数](./src/p2586_count_the_number_of_vowel_strings_in_range.rs) (哈希表+简单模拟)
...
- [p435. non overlapping intervals 无重叠区间](./src/p435_non_overlapping_intervals.rs)
